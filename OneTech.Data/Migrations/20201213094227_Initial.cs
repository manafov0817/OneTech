        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountWithPercent = table.Column<int>(type: "int", nullable: false),
                    DiscountWithMoney = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DiscountStart = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DiscountEnd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductOptionValues", x => new { x.ProductId, x.OptionValueId });
                    table.ForeignKey(
